...
- Add support for ``FileModifiedTimeHWM`` HWM class (see `etl-entities 2.5.0 <https://github.com/MTSWebServices/etl-entities/releases/tag/2.5.0>`_):
...
- Minimal ``etl-entities`` version is now `2.5.0 <https://github.com/MTSWebServices/etl-entities/releases/tag/2.5.0>`_. (:github:pull:`331`)
