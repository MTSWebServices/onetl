...
- Add note about `spark-dialect-extension <https://github.com/MTSWebServices/spark-dialect-extension>`_ package to Clickhouse connector documentation. (:github:pull:`310`)
