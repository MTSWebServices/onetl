...
class MSSQL(JDBCConnection):
    ...
    Based on Maven package [com.microsoft.sqlserver:mssql-jdbc:13.6.0.jre8](https://mvnrepository.com/artifact/com.microsoft.sqlserver/mssql-jdbc/13.6.0.jre8)
    ...
    def get_packages(
        ...
        package_version
            Specifies the version of the MSSQL JDBC driver to use. Defaults to `13.6.0.`.
        ...
        MSSQL.get_packages(java_version="8", package_version="13.6.0.jre11")
        ```
        """
        default_java_version = "8"
        default_package_version = "13.6.0"
    ...
    def package(cls) -> str:
        ...
        return "com.microsoft.sqlserver:mssql-jdbc:13.6.0.jre8"
