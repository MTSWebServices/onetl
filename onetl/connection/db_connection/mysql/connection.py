...
class MySQL(JDBCConnection):
    ...
    Based on Maven package `com.mysql:mysql-connector-j:9.4.0 <https://mvnrepository.com/artifact/com.mysql/mysql-connector-j/9.4.0>`_
    ...
    def get_packages(cls, package_version: str | None = None) -> list[str]:
        ...
        package_version : str, optional
            Specifies the version of the MySQL JDBC driver to use. Defaults to ``9.4.0``.
    ...
    def package(cls) -> str:
        ...
        return "com.mysql:mysql-connector-j:9.4.0"
