...
def test_mssql_package():
    ...
    with pytest.warns(UserWarning, match=warning_msg):
        assert MSSQL.package == "com.microsoft.sqlserver:mssql-jdbc:13.2.1.jre8"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("9", None, ["com.microsoft.sqlserver:mssql-jdbc:13.2.1.jre8"]),
        ("11", None, ["com.microsoft.sqlserver:mssql-jdbc:13.2.1.jre11"]),
        ("20", None, ["com.microsoft.sqlserver:mssql-jdbc:13.2.1.jre11"]),
        ("8", "13.2.1.jre8", ["com.microsoft.sqlserver:mssql-jdbc:13.2.1.jre8"]),
        ("11", "13.2.1.jre11", ["com.microsoft.sqlserver:mssql-jdbc:13.2.1.jre11"]),
        ...
        ("8", "13.2.1", ["com.microsoft.sqlserver:mssql-jdbc:13.2.1.jre8"]),
        ("11", "13.2.1", ["com.microsoft.sqlserver:mssql-jdbc:13.2.1.jre11"]),
    ],
)
