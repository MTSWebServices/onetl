# Reading from Hive using `DBReader` { #DBR-onetl-connection-db-connection-hive-read-reading-from-hive-using-dbreader }

[DBReader][DBR-onetl-db-reader] supports [strategy][DBR-onetl-strategy-read-strategies] for incremental data reading,
but does not support custom queries, like `JOIN`.

## Supported DBReader features { #DBR-onetl-connection-db-connection-hive-read-supported-dbreader-features }
...
## Examples { #DBR-onetl-connection-db-connection-hive-read-examples }
...
### Use column-based write formats { #DBR-onetl-connection-db-connection-hive-read-use-column-based-write-formats }
...
### Select only required columns { #DBR-onetl-connection-db-connection-hive-read-select-only-required-columns }
...
### Use partition columns in `where` clause { #DBR-onetl-connection-db-connection-hive-read-use-partition-columns-in-where-clause }
