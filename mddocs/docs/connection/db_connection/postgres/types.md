# Postgres <-> Spark type mapping { #DBR-onetl-connection-db-connection-postgres-types-postgres-spark-type-mapping }

!!! note

    The results below are valid for Spark 3.5.8, and may differ on other Spark versions.

## Type detection & casting { #DBR-onetl-connection-db-connection-postgres-types-type-detection-casting }

Spark's DataFrames always have a `schema` which is a list of columns with corresponding Spark types. All operations on a column are performed using column type.

### Reading from Postgres { #DBR-onetl-connection-db-connection-postgres-types-reading-from-postgres }
...
### Writing to some existing Postgres table { #DBR-onetl-connection-db-connection-postgres-types-writing-to-some-existing-postgres-table }
...
### Create new table using Spark { #DBR-onetl-connection-db-connection-postgres-types-create-new-table-using-spark }
...
## Supported types { #DBR-onetl-connection-db-connection-postgres-types-supported-types }

### References { #DBR-onetl-connection-db-connection-postgres-types-references }
...
- [JDBC -> Spark](https://github.com/apache/spark/blob/v3.5.8/sql/core/src/main/scala/org/apache/spark/sql/jdbc/PostgresDialect.scala#L52-L108)
- [Spark -> JDBC](https://github.com/apache/spark/blob/v3.5.8/sql/core/src/main/scala/org/apache/spark/sql/jdbc/PostgresDialect.scala#L118-L132)

### Numeric types { #DBR-onetl-connection-db-connection-postgres-types-numeric-types }
...
### Temporal types { #DBR-onetl-connection-db-connection-postgres-types-temporal-types }
...
### String types { #DBR-onetl-connection-db-connection-postgres-types-string-types }
...
### Binary types { #DBR-onetl-connection-db-connection-postgres-types-binary-types }
...
### Struct types { #DBR-onetl-connection-db-connection-postgres-types-struct-types }
...
### Network types { #DBR-onetl-connection-db-connection-postgres-types-network-types }

| Postgres type (read) | Spark type            | Postgres type (write) | Postgres type (create)  |
|----------------------|-----------------------|-----------------------|-------------------------|
| `cidr`<br/>`inet`<br/>`macaddr`<br/>`macaddr8`             | `StringType()` [^1] | <br/><br/>`text`              | <br/><br/>`text`                |

### Geo types { #DBR-onetl-connection-db-connection-postgres-types-geo-types }

| Postgres type (read) | Spark type            | Postgres type (write) | Postgres type (create)  |
|----------------------|-----------------------|-----------------------|-------------------------|
| `circle`<br/>`box`<br/>`line`<br/>`lseg`<br/>`path`<br/>`point`<br/>`polygon`           | <br/><br/><br/>`StringType()` [^1] | <br/><br/><br/>`text`              | <br/><br/><br/>`text`                |

## Explicit type cast { #DBR-onetl-connection-db-connection-postgres-types-explicit-type-cast }

### `DBReader` { #DBR-onetl-connection-db-connection-postgres-types-dbreader }
...
### `DBWriter` { #DBR-onetl-connection-db-connection-postgres-types-dbwriter }
...
#### Using JSON.serialize_column { #DBR-onetl-connection-db-connection-postgres-types-using-json-serialize-column }
...
#### Manual conversion to string { #DBR-onetl-connection-db-connection-postgres-types-manual-conversion-to-string }
