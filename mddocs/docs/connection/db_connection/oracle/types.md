# Oracle <-> Spark type mapping { #DBR-onetl-connection-db-connection-oracle-types-oracle-spark-type-mapping }
...
### Reading from Oracle { #DBR-onetl-connection-db-connection-oracle-types-reading-from-oracle }
...
### Writing to some existing Oracle table { #DBR-onetl-connection-db-connection-oracle-types-writing-to-some-existing-oracle-table }
...
### Create new table using Spark { #DBR-onetl-connection-db-connection-oracle-types-create-new-table-using-spark }
...
## Supported types { #DBR-onetl-connection-db-connection-oracle-types-supported-types }

### References { #DBR-onetl-connection-db-connection-oracle-types-references }
...
### Temporal types { #DBR-onetl-connection-db-connection-oracle-types-temporal-types }

| Oracle type (read)                         | Spark type                         | Oracle type (write)             | Oracle type (create)            |
|--------------------------------------------|------------------------------------|---------------------------------|---------------------------------|
| `DATE`, days                             | `TimestampType()`, microseconds  | `TIMESTAMP(6)`, microseconds  | `TIMESTAMP(6)`, microseconds  |
| `TIMESTAMP`, microseconds<br/>`TIMESTAMP(0)`, seconds<br/>`TIMESTAMP(3)`, milliseconds<br/>`TIMESTAMP(6)`, microseconds               | <br/><br/>`TimestampType()`, microseconds  | <br/><br/>`TIMESTAMP(6)`, microseconds  | <br/><br/>`TIMESTAMP(6)`, microseconds |
...
### String types { #DBR-onetl-connection-db-connection-oracle-types-string-types }
...
### Binary types { #DBR-onetl-connection-db-connection-oracle-types-binary-types }
...
### Struct types { #DBR-onetl-connection-db-connection-oracle-types-struct-types }
...
### Special types { #DBR-onetl-connection-db-connection-oracle-types-special-types }
...
## Explicit type cast { #DBR-onetl-connection-db-connection-oracle-types-explicit-type-cast }

### `DBReader` { #DBR-onetl-connection-db-connection-oracle-types-dbreader }
...
### `DBWriter` { #DBR-onetl-connection-db-connection-oracle-types-dbwriter }
