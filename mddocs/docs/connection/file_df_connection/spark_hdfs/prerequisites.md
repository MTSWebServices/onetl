...
## Using Kerberos { #DBR-onetl-connection-file-df-connection-spark-hdfs-prerequisites-using-kerberos }
...
**BEFORE** starting Spark session to generate Kerberos ticket. See [Kerberos installation instructions][DBR-onetl-install-kerberos-support].
