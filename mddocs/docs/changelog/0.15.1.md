...
## Breaking Changes { #DBR-onetl-changelog-0-15-1-breaking-changes }

Mark Greenplum connector as deprecated and pending for removal in v1.0.0.

## Features { #DBR-onetl-changelog-0-15-1-features }
...
## Improvements { #DBR-onetl-changelog-0-15-1-improvements }
