# Spark Troubleshooting { #DBR-onetl-troubleshooting-spark-troubleshooting }

## Restarting Spark session { #DBR-onetl-troubleshooting-spark-restarting-spark-session }
...
## Driver log level { #DBR-onetl-troubleshooting-spark-driver-log-level }
...
## Executors log level { #DBR-onetl-troubleshooting-spark-executors-log-level }
